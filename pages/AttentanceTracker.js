        ...
        try {
            ...
            if (videoRef.current) {
                ...
                videoRef.current.onloadedmetadata = async () => {
                    ...
                    setCameraMsg("Camera ready. Position barcode inside the frame.");
                ...
                <div className="glass-card fade-in">
                    ...
                    {step === 1 && !loadingMsg && (
                        <div className="step-content">
                            ...
                            <p className="subtitle">Securely sign in with your OntarioTechU account to access class rosters.</p>
                    ...
                    {step === 2 && (
                        <div className="step-content">
                            ...
                            <div className="form-group">
                                <label>Master Spreadsheet</label>
                                            ...
                                            onClick={async () => {
                                                ...
                                                if (videoRef.current && videoRef.current.srcObject) {
                                                    ...
                                                    try {
                                                        ...
                                                        setTimeout(() => setCameraMsg("Camera ready. Position barcode inside the frame."), 1000);
                                                    } catch(e) {}
                                                }
                                            }}
                                        ></video>
